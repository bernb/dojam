class MaterialSpecifiedsKindOfObjectSpecified < ApplicationRecord
  ...
  has_many :termlist_kind_of_object_specifieds_decoration_techniques, inverse_of: :material_specifieds_kind_of_object_specified
