...
class TermlistProductionTechniqueDashboard < Administrate::BaseDashboard
  ...
  # Overwrite this method to customize how termlist production techniques are displayed
  # across all pages of the admin dashboard.
  #
  # def display_resource(termlist_production_technique)
  #   "TermlistProductionTechnique ##{termlist_production_technique.id}"
  # end
end
