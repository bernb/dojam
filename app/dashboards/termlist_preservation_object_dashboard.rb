...
class TermlistPreservationObjectDashboard < Administrate::BaseDashboard
  # ATTRIBUTE_TYPES
  ...
  # Overwrite this method to customize how termlist preservation objects are displayed
  # across all pages of the admin dashboard.
  #
  # def display_resource(termlist_preservation_object)
  #   "TermlistPreservationObject ##{termlist_preservation_object.id}"
  # end
end
