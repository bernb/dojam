...
class TermlistInscriptionLetterDashboard < Administrate::BaseDashboard
  # ATTRIBUTE_TYPES
  ...
  # Overwrite this method to customize how termlist inscription letters are displayed
  # across all pages of the admin dashboard.
  #
  # def display_resource(termlist_inscription_letter)
  #   "TermlistInscriptionLetter ##{termlist_inscription_letter.id}"
  # end
end
