...
class TermlistDatingCenturyDashboard < Administrate::BaseDashboard
  # ATTRIBUTE_TYPES
  ...
  # Overwrite this method to customize how termlist dating centuries are displayed
  # across all pages of the admin dashboard.
  #
  # def display_resource(termlist_dating_century)
  #   "TermlistDatingCentury ##{termlist_dating_century.id}"
  # end
end
