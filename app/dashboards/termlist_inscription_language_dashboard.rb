...
class TermlistInscriptionLanguageDashboard < Administrate::BaseDashboard
  # ATTRIBUTE_TYPES
  ...
  # Overwrite this method to customize how termlist inscription languages are displayed
  # across all pages of the admin dashboard.
  #
  # def display_resource(termlist_inscription_language)
  #   "TermlistInscriptionLanguage ##{termlist_inscription_language.id}"
  # end
end
