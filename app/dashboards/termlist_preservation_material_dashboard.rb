...
class TermlistPreservationMaterialDashboard < Administrate::BaseDashboard
  # ATTRIBUTE_TYPES
  ...
  # Overwrite this method to customize how termlist preservation materials are displayed
  # across all pages of the admin dashboard.
  #
  # def display_resource(termlist_preservation_material)
  #   "TermlistPreservationMaterial ##{termlist_preservation_material.id}"
  # end
end
