...
class TermlistDecorationTechniqueDashboard < Administrate::BaseDashboard
  # ATTRIBUTE_TYPES
  ...
  # Overwrite this method to customize how termlist decoration techniques are displayed
  # across all pages of the admin dashboard.
  #
  # def display_resource(termlist_decoration_technique)
  #   "TermlistDecorationTechnique ##{termlist_decoration_technique.id}"
  # end
end
