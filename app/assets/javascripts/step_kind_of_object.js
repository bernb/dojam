...
function get_kind_of_object_list() {
	$.ajax({
		...
		type: "GET",
		data: {
			selected_material_specified_id: $('input[name=museum_object\\[main_material_specified_id\\]]:checked').val(),
...
function step_kind_of_object_js() {
  ...
  $('input[name=museum_object\\[main_material_specified_id\\]]').change(get_kind_of_object_list);
}
